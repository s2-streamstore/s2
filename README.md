...
<details>
<summary>In-memory (default)</summary>
...
<details>
<summary>Local storage with PersistentVolumeClaim</summary>
...
<details>
<summary>TLS with self-signed certificates</summary>
...
For all configuration options, see the [values.yaml](charts/s2-lite/values.yaml) file.
