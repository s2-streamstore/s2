...
> [!TIP]
> S2 has an HTTP API with an [OpenAPI spec](api/specs/s2/v1/openapi.json).
> The data plane additionally supports [Protobuf messages](https://buf.build/streamstore/s2/docs/main:s2.v1) and a minimal binary protocol over HTTP/2 called `S2S`, to support streaming requirements efficiently. This is fully documented [here](http://s2.dev/docs/api/records/overview).
