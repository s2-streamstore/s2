...
fn is_not_found_error(e: &s2_sdk::types::RequestError) -> bool {
    matches!(e, s2_sdk::types::RequestError::Server(s2_sdk::types::ErrorResponse { code, .. }) if code == "basin_not_found" || code == "stream_not_found")
}
