...
impl From<Operation> for sdk::types::Operation {
    fn from(op: Operation) -> Self {
        match op {
            ...
            Operation::ListScopes => sdk::types::Operation::ListScopes,
            Operation::GetDefaultScope => sdk::types::Operation::GetDefaultScope,
            Operation::SetDefaultScope => sdk::types::Operation::SetDefaultScope,
...
impl From<sdk::types::Operation> for Operation {
    fn from(op: sdk::types::Operation) -> Self {
        match op {
            ...
            sdk::types::Operation::ListScopes => Operation::ListScopes,
            sdk::types::Operation::GetDefaultScope => Operation::GetDefaultScope,
            sdk::types::Operation::SetDefaultScope => Operation::SetDefaultScope,
