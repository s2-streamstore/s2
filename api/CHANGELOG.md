...
- Skip s2s response compression the client refused with q=0 ([#781](https://github.com/s2-streamstore/s2/issues/781))
...
- S2s reconnect advice flag and server_draining error code ([#700](https://github.com/s2-streamstore/s2/issues/700))
